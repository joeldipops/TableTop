...
-- | Spiked Tea | Equipment (Consumable) | -- | C-Assassin-1 | -- | Opponent rolls their Diplomacy Die; Discard This: Roll your diplomacy die and Opponent loses that amount of 💗.
...
-- | Tune of Seduction | Consumable (Spell) | -- |C-Bard-2 | -- | **Encounter**; Discard This: Take an amount of 🌈 from opponent up to `your Cha - their Cha`
...
-- | Life Drain | Consumable (Spell) | -- | C-Sorcerer-1 | -- | **Encounter**; Discard This: Make a Simple Parley. Increase your ⚡ by the amount of ⚡ damage
...
-- | Prudence | Consumable | -- | -- | -- | Discard This; Discard a card from your Hand: Add 🌈 equal to the card's 🌈 cost.
...
-- | Potion | Consumable (Potion) | -- | -- | BeltPouch | Discard This: +10💗
...
-- | Dodge | Consumable (Event) | -- | -- | -- | Discard This: Take no 💗 damage this turn.
